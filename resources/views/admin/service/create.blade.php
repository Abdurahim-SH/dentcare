                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    @error('after_image') <p class="text-danger">{{$message}}</p> @enderror
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    @error('before_image') <p class="text-danger">{{$message}}</p> @enderror
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    @error('cosmetic_image') <p class="text-danger">{{$message}}</p> @enderror
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    @error('dental_image') <p class="text-danger">{{$message}}</p> @enderror
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    @error('bridges_image') <p class="text-danger">{{$message}}</p> @enderror
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    @error('teeth_image') <p class="text-danger">{{$message}}</p> @enderror
