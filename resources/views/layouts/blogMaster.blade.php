...
<head>
    ...
    <link href="{{asset('blog/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="" class="dropdown-item">@lang('word.blog')</a>
                    </div>
                </div>
                ...
                <div class="modal-body d-flex align-items-center justify-content-center"">
                   <form action="{{ url('search')}}" method="GET">
                        <div class="input-group" style="max-width: 800px;">
                            <input type="search" name="q" class="form-control bg-transparent border-primary p-3" placeholder="Type search keyword">
    ...
    <div class="container-fluid position-relative pt-5 wow fadeInUp" data-wow-delay="0.1s" style="z-index: 1;">
        <div class="container">
            ...
            @if($mess = Session::get('email'))
             <span style="color: black">{{ $mess }}</span>
            @endif
